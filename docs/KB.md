...
- Default branch: `main`.
- Verified source revision: `4be1e15`.
...
- `CHANGELOG.md` records version 0.2.21 as the latest repository release entry, with share-menu folding survival and stripless crop dated 2026-09-14. This is repository release-note state, not proof of a published release.
