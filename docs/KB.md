...
- Default branch: `main`.
- Reviewed source revision: `6e8c3a0`.
...
- `CHANGELOG.md` records version 0.2.35 as the latest repository release entry, with history preservation, side-notch interaction, and Antigravity recovery fixes dated 2026-09-23. This is repository release-note state, not proof of a published release.
