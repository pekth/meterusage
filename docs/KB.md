...
- `CHANGELOG.md` records version 0.2.33 as the latest repository release entry, with the burn-attribution zero-card fix dated 2026-09-20. This is repository release-note state, not proof of a published release.
