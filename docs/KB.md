...
- `CHANGELOG.md` records version 0.2.23 as the latest repository release entry, with today derived from session activity windows against local midnight in the unreleased change that follows it. This is repository release-note state, not proof of a published release.
